defmodule OVCSInfotainmentSystemRpi4.MixProject do
  use Mix.Project

  @github_organization "ovcs"
  @app :ovcs_infotainment_system_rpi4
  ...
  defp deps do
    [
      ...
      {:nerves_system_br, github: "Spin42/nerves_system_br", runtime: false},
  ...
  defp description do
    "Nerves System for OVCS infotainment system - Raspberry Pi 4 (64-bits)"
  end
