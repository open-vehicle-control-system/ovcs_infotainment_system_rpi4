...
./deps/nerves_system_br/create-build.sh nerves_defconfig .nerves/artifacts/ovcs_infotainment_system_rpi4-portable-${VERSION} >/dev/null
cd .nerves/artifacts/ovcs_infotainment_system_rpi4-portable-${VERSION}
